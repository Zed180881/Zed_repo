...
public class OrderMailServiceImpl {
	...
	MimeMessagePreparator preparator = new MimeMessagePreparator() {
		...
		mimeMessage.setSubject("Ваше замовлення");
		mimeMessage.setText(
		"Шановний " + order.getUser().getFullName()
			+ ", Дякуємо за Ваше замовлення. Номер замовлення "
			+ order.getId() + " Сума замовлення " + order.getSum() + " грн.");
	    }
	};
	...
	MimeMessagePreparator preparator = new MimeMessagePreparator() {
		...
		mimeMessage.setFrom(new InternetAddress(
			"e-shop-support@e-shop.com"));
		mimeMessage.setSubject("Нове замовлення");
		mimeMessage.setText(
		"Увага у Вас нове замовлення. Номер замовлення "
			+ order.getId() + " Сума замовлення " + order.getSum() + " грн.");
	    }
	};
