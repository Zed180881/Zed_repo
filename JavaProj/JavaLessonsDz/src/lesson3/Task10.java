...
//Створіть масив з 11 випадкових цілих чисел з відрізка [-1; 1], виведіть 
//масив на екран у рядок. Визначте який елемент зустрічається в масиві найчастіше 
//і виведіть про це повідомлення на екран. Якщо два якихось елемента зустрічаються 
...
public class Task10 {
	...
	public static void main(String[] args) {
		...
		if (arrayCountElement(-1, arr) > arrayCountElement(0, arr)
			...
			System.out.println("Найчастіше зустрічається елемент -1");
		if (arrayCountElement(0, arr) > arrayCountElement(-1, arr)
				&& arrayCountElement(0, arr) > arrayCountElement(1, arr))
			System.out.println("Найчастіше зустрічається елемент 0");
