...
public class Main {
    ...
    private static PersonManagement pm = restorePersons("saves.person");
    ...
    private static void generateSummary(String path) {
    ...
    private static PersonManagement restorePersons(String string) {
	try (ObjectInputStream oos = new ObjectInputStream(new FileInputStream(
		string))) {
	    return (PersonManagement) oos.readObject();
